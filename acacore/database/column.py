...
class ColumnSpec:
    ...
    def from_schema(cls, name: str, schema: dict, defs: dict[str, dict] | None = None) -> Self:
        ...
        return cls(name=name, type=sql_type, to_sql=to_sql, from_sql=from_sql, nullable=nullable)

    @classmethod
    def from_model(cls, model: Type[BaseModel], ignore: list[str] | None = None) -> list[Self]:
        """
